 ...
 * @author levail
 */
public class PROD_FROM_CAT extends javax.swing.JFrame {

    /**
     * Creates new form PRODUCTS_IN_CATEGORY_FORM
     */
    public PROD_FROM_CAT() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PROD_FROM_CAT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PROD_FROM_CAT().setVisible(true);
            }
        });
    }
